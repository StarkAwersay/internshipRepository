...
public class MainPage extends PageFactory {
    ...
    @FindBy(xpath = "//li[contains(@id,'25')]/a[contains(@class,'menu')]/span[contains(text(),'Member Login')]")
    ...
    @FindBy(xpath = "//a[contains(@class,'menu-link')]/span[text()='Practice Site 2']")
    ...
    @FindBy(xpath = "//div[contains(@data-id,'15')]/div[contains(@class,'swiper-container')]")
    ...
    public void goToPracticeSite2() {
        resourcesButton.click();
        Waiting.waitingElementsDisplay(practiceSite2Button, driver).click();
    }
